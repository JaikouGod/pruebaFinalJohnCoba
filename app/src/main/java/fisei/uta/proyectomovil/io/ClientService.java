...
public class ClientService {
    ...
    public void getUserForEmail(Context context, final ClientService.ClientResponseListener listener) {
        String url = "http://"+dominio+"/api/Usuarios/ObtenerUsuarioxEmail";
    ...
    public void getUserForEmail2(Context context, String gmail,final ClientService.ClientResponseListener listener) {
        String url = "http://"+dominio+"/api/Usuarios/ObtenerUsuarioxEmail";
        String encodedEmail = gmail.replace("@", "%40");
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url+encodedEmail, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
    ...
    String urlUpdate= "http://"+dominio+"/api/Usuarios/ActualizarUsuario/";
    ...
    public void updateEstado(Context context,String gmail,boolean estado, final ClientService.ClientResponseListener listener){
        String encodedEmail = gmail.replace("@", "%40");
        String urlUpdate= "http://"+dominio+"/api/Usuarios/ActualizarEstadoPorGmail?gmail="+encodedEmail+"&estado="+estado;
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, urlUpdate, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                listener.onResponse(jsonObject);
            }
